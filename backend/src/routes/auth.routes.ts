...
// --- Rep signup ------------------------------------------------------------
// Auto-verifies if the email domain matches a KnownManufacturerDomain,
// otherwise leaves status UNVERIFIED until an ID is uploaded and reviewed.
...
// --- Office staff login --------------------------------------------------
// (Staff accounts are created by an admin/onboarding flow, not self-signup —
// this route just authenticates an existing StaffUser.)
